    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <!-- /.dropdown -->  <li><i class="fa fa-users"> <?php 
                        $sql=mysql_fetch_array(mysql_query("select username as akun from akun where roll='direktur'"));
                        echo $sql['akun']
                        ?></i></li>
             
                        <li><i class=""></i><?= anchor("direktur/logout","Log Out") ?>
           ...
           <?php echo $this->load->view('navigator_menu/tampilan_direktur')?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">

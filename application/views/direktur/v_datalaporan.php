...
<div class="row">
<center>
<?php echo form_open('/direktur/vchart');?>
    <select name="tahun">
    ...
    datasets: [
        {
            ...
            fillColor: '#382765',
            data: [<?php echo count($v_chart_januari)?>,<?php echo count($v_chart_februari)?>,<?php echo count($v_chart_maret)?>,<?php echo count($v_chart_april)?>,]
        }
    ]
};

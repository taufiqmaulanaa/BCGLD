...
<body background ="http://localhost/BCGLD/login2.jpg">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><center>APLIKASI PEMESANAN DAN PENGELOLAAN DATA PRODUKSI</center> </h3>
                    </div>
                    <div class="panel-body">
                        <h3 class="panel-title"><center>PLEASE SIGN</center> </h3> <br>
                        <form method="POST" action ="<?php echo base_url();?>index.php/login/getlogin" onsubmit="return cekform();" >
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control"placeholder="Username" id="username" name="username" type="username" required>
                                </div>
                                <div class="form-group">
 ...
 <div class="footer"><br><br><br><br><br><br><br><br>
       <center> <p>&copy; Beachgold Lifestyle</p></center>
    </div>
</html>
